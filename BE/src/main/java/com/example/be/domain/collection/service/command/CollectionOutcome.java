 ...
 */
public record CollectionOutcome(FetchResult fetch,
    ...
    public static CollectionOutcome blockedByRobots(RobotsDecision robots) {
        return new CollectionOutcome(FetchResult.ok(java.util.List.of()), robots, false, null, null, false);
    }

    public static CollectionOutcome of(FetchResult fetch, RobotsDecision robots) {
