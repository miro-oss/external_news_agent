...
현재 사용되는 프롬프트는 v2입니다. `self-critique.ko.v1.md`는 과거 실행의 프롬프트를 추적하기 위해
보존하며, v1의 모델 원본 복사 요구를 v2에서는 서버의 원본 보존으로 바꿨습니다.
...
감사 target은 `REPORT`, `collection_run_id`는 null입니다.
