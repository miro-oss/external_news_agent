"""PydanticAI adapters that preserve the established Mindlogic wire contract."""
...
async def preserve_mindlogic_trailing_slash(request: httpx2.Request) -> None:
    """Keep the production `/chat/completions/` endpoint including its slash."""
...
def extract_mindlogic_credits(
    ...
    *,
    ...
    return parse_usage_decimal(details, *_PROVIDER_CREDIT_KEYS, default=default)
...
def extract_mindlogic_cost_usd(
    ...
    *,
    ...
    details = response.provider_details or {}
    return parse_usage_decimal(details, *_PROVIDER_COST_KEYS, default=default)
