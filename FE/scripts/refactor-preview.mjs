                ...
                server.middlewares.use(async (req, res, next) => {
                    ...
                    try {
                        ...
                        if (path.startsWith('/__qa/')) {
                            ...
                            if (path === '/__qa/state')
                                return json(res, { runs, policies, telegram, readiness, autoDeliveries });
                        ...
                        if (path === '/api/usage/llm') {
                            ...
                            if (!result) {
                                const targetTopicIds = body.topicIds || topics.filter(t => t.active).map(t => t.id);
